...
Diese Cookie-Richtlinie erläutert, wie **{SITE?.name}** Cookies und ähnliche Tracking-Technologien auf unserer Website einsetzt. Sie ergänzt unsere Datenschutzerklärung und Nutzungsbedingungen.
...
| `cookieconsent_status` | {SITE?.name} | Speichert Ihre Cookie-Einwilligungsentscheidung | 1 Jahr |
