...
Diese Cookie-Richtlinie erläutert, wie **{SITE.owner.companyName}** Cookies und ähnliche Tracking-Technologien auf unserer Website einsetzt. Sie ergänzt unsere [Datenschutzerklärung](/de/privacy-policy) und [Nutzungsbedingungen](/de/terms-of-service).
...
- Vor dem Abspielen werden **keine Cookies oder Local-Storage-Einträge** gesetzt
- Beim aktiven Abspielen werden Daten inkl. IP-Adresse an YouTube übertragen
- YouTube verwendet neben Cookies auch **Local Storage** zur Speicherung von Nutzerpräferenzen und technischen Daten für die Videowiedergabe
...
| `yt-remote-connected-devices` | YouTube | Speichert verbundene Geräte (Local Storage) | 1 Jahr |
| `yt.innertube::nextId` | YouTube | Interne API-Anfragen-Zählung (Local Storage) | 1 Tag |
| `yt.innertube::requests` | YouTube | Zwischenspeicherung von API-Anfragen (Local Storage) | 1 Tag |
| `ytidb::LAST_RESULT_ENTRY_KEY` | YouTube | Speichert Status der letzten Datenbankabfrage (Local Storage) | 30 Tage |
...
- **Mozilla Firefox:** [https://support.mozilla.org/de/kb/cookies-informationen-websites-speichern](https://support.mozilla.org/de/kb/cookies-informationen-websites-speichern)
- **Safari (macOS):** [https://support.apple.com/de-de/guide/safari/sfri11471/mac](https://support.apple.com/de-de/guide/safari/sfri11471/mac)
- **Safari (iOS):** [https://support.apple.com/de-de/HT201265](https://support.apple.com/de-de/HT201265)
- **Microsoft Edge:** [https://support.microsoft.com/de-de/windows/verwalten-von-cookies-in-microsoft-edge](https://support.microsoft.com/de-de/windows/verwalten-von-cookies-in-microsoft-edge)
